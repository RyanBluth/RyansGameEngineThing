...
class SpriteSheetHandler
{
	...
	public function getSpriteArray(imgWidth:Int, imgHeight:Int, spriteWidth:Int, spriteHeight:Int, startXCoord:Int, startYCoord:Int, endXCoord, endYCoord):Array<Rectangle>
	{
			var spritesX:Int;
